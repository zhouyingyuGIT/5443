                ...
                init: function(e) {
                    ...
                    switch (this.gameModule) {
                        ...
                        case 2:
                            ...
                            //alert( this.recordGameModule2 );
                            this.recordGameModule2=180000;//180秒
                            break;
                        case 3:
                        ...
                        case 2:
                            if (this.recordGameModule2 > 0) {
                                ...
                                if (this.dateGameModule2) {
                                    ...
                                    //alert(this.recordGameModule2);
                                    //this.recordGameModule2=30000;//180秒 3分钟
                                    
                                }
                                //this.topTitle = this.getRecordGameModuleStr(this.recordGameModule2) + '"', this.recordGameModule2 > 5e3 ? this.topTitleColor = "#0F0" : this.recordGameModule2 > 2e3 ? this.topTitleColor = "#FF9900" : this.topTitleColor = "#F00", this.touchTimesColor = "rgba(" + ~~(256 - 100 * (this.touchTimes2 / this.maxTouchTimes)) + "," + ~~(256 * (this.touchTimes2 / this.maxTouchTimes)) + ", 0, 1)", this.touchTimes2 >= this.maxTouchTimes && (this.touchTimes2 = 0, this.recordGameModule2 = 180000, this.dateGameModule1 = Date.now())
                                this.topTitle = this.getRecordGameModuleStr(this.recordGameModule2) + '"', this.recordGameModule2 > 5e3 ? this.topTitleColor = "#0F0" : this.recordGameModule2 > 2e3 ? this.topTitleColor = "#FF9900" : this.topTitleColor = "#F00", this.touchTimesColor = "rgba(" + ~~(256 - 100 * (this.touchTimes2 / this.maxTouchTimes)) + "," + ~~(256 * (this.touchTimes2 / this.maxTouchTimes)) + ", 0, 1)", this.touchTimes2 >= this.maxTouchTimes
                            } else {
                    ...
                    switch (this.gameModule) {
                        ...
                        case 1:
                            ...
                            if (!this.shownTut1) {
                                e.canvas.drawString("别点到白块儿噢", 0, 130, e.graphics.VCENTER, !0, "#f00", "#000", "28px 微软雅黑");
                                e.canvas.drawString("点击最下面的黑块儿", 0, 160, e.graphics.VCENTER, !0, "#0f0", "#000", "23px 微软雅黑");
                                e.canvas.drawString("180秒内看点击到多少黑色块儿", 0, 190, e.graphics.VCENTER, !0, "#0f0", "#000", "23px 微软雅黑")
                            }
                            break;
                        case 2:
                            ...
                            //alert(t+'='+this.touchTimes2 +'='+ this.maxTouchTimes);
                            if (!this.shownTut2) {
                                e.canvas.drawString("别点到白块儿噢", 0, 130, e.graphics.VCENTER, !0, "#f00", "#000", "28px 微软雅黑");
                                e.canvas.drawString("点击最下面的黑块儿", 0, 160, e.graphics.VCENTER, !0, "#0f0", "#000", "23px 微软雅黑");
