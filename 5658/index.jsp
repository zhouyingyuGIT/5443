...
.fc{
    font-weight: 700;font-size: 30px;padding: 8px;
}
        #step1{
            display: block;
...
<div class="box">
    ...
    <div id="step1" class="step">
        <div style="line-height: 100px;font-size: 28px;text-align: center;font-weight: 700;">看心算</div>
        <div id="wrap">
            <div id="tit">
    ...
    <div id="step2" class="step">
        ...
        <div class="ti">
            <div id="numFC">
                <div id="fc1" class="fc" style=""></div>
                <div id="fc2" class="fc" style=""></div>
                <div id="fc3" class="fc" style=""></div>
                <div id="fc4" class="fc" style=""></div>
                <div id="fc5" class="fc" style=""></div>
                <div id="fc6" class="fc" style=""></div>
            </div>
            <input onkeyup="this.value=this.value.replace(/\D/g,'')" id="answer" type="text">
        </div>
        <div class="buttonBox">
            <button disabled="disabled" id="stepBtn2" class="btn">确认</button>
        </div>
